...
#Create vector t
t <- c(1:nobs)
data <- data.frame("t"=t,"inflow"=inflow_data$HP1)

#Fit a linear trend to TS of iHP
linear_trend_model=lm(inflow~t,data)
...
detrend_inflow<-inflow_data$HP1- linear_trend
...
autoplot(ts_inflow_data, color="darkblue") +
...
dummies <- seasonaldummy(ts_detrend) #this function only accepts ts object
